...
// Placeholder route — reserves the /promotions link in the sidebar for
// future development; no functionality here yet.
export default function PromotionsPage() {
  return (
    <AppShell>
      <main className="min-h-screen bg-cream px-4 py-4">
        <div className="max-w-6xl mx-auto">
          <h1 className="font-serif text-2xl text-deep-violet-blue mb-3">Promotions</h1>
