...
│   │   │   ├── inventory.py       InventoryRecordCreate/Update, ShippedSoFarUpdate, DohThresholdUpdate
...
│   │       ├── inventory_service.py inventory_metrics + customer_doh_targets reads/writes (raw SQL, one txn per write)
